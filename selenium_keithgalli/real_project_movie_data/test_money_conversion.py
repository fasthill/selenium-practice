...
if __name__ == "__main__":
	print("test")
	test_standard()
	test_standard_double_digit()
	test_standard_with_decimal()
	test_standard_multiple_decimals()
	test_standard_billion()
	test_standard_thousand()
	test_range()
	test_range_with_to()
	test_number()
	test_number_with_commas()
	test_number_with_commas_and_decimals()
	test_number_with_commas_middle()
	test_other_currency()
	test_list()
	test_unkown()